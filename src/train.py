...
if __name__ == "__main__":
    ...
    data, _ = preprocess_data(r'C:\Users\PC\Desktop\Synthetic-Data-Generation-with-Generative-AI-main\Synthetic-Data-Generation-with-Generative-AI-main\data\screentime_analysis.csv')
